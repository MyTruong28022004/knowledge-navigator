...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const hasPermission = useCallback((permission: string) => {
    ...
    const permissionRequirements: Record<string, UserRole[]> = {
      ...
      'search': ['employee', 'department_manager', 'knowledge_manager', 'admin'],
      'documents.view': ['employee', 'department_manager', 'knowledge_manager', 'admin'],
      'documents.edit': ['knowledge_manager', 'admin'],
  ...
  return (
    <AuthContext.Provider value={{ user, isAuthenticated, login, logout, hasRole, hasPermission }}>
      {children}
