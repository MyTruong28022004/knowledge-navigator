import { Conversation, ChatMessage, Citation, Document, SearchResult, AuditLogEntry, Job } from '@/types';
...
export const mockCitations: Citation[] = [
  {
    ...
    snippet: 'Nhân viên cần đăng ký nghỉ phép trước ít nhất 3 ngày làm việc thông qua hệ thống HR Portal. Đối với nghỉ phép trên 5 ngày, cần được sự phê duyệt của Trưởng phòng.',
    score: 0.92,
  },
  {
    id: 'cit-2',
    ...
    snippet: 'Mỗi nhân viên chính thức được hưởng 12 ngày phép năm. Ngày phép không sử dụng có thể được chuyển sang năm sau với tối đa 5 ngày.',
    score: 0.87,
  },
];
...
export const mockSearchResults: SearchResult[] = [
  {
    ...
    documentId: 'doc-1',
    title: 'Quy trình nghỉ phép năm 2024',
    snippet: 'Nhân viên cần đăng ký nghỉ phép trước ít nhất 3 ngày làm việc thông qua hệ thống HR Portal...',
    sectionPath: 'Section 2.1 > Đăng ký nghỉ phép',
    classification: 'internal',
    status: 'approved',
    updatedAt: '2024-01-10T08:00:00Z',
  ...
  },
  {
    ...
    snippet: 'Mỗi nhân viên chính thức được hưởng 12 ngày phép năm. Ngày phép không sử dụng có thể được chuyển sang năm sau...',
    sectionPath: 'Chapter 4 > Nghỉ phép',
    classification: 'internal',
    status: 'approved',
    updatedAt: '2024-01-08T14:30:00Z',
